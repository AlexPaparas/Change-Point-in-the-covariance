...
# 
# # Visualization
# plot(x = nagao_results$test_statistics[, "candidate_cp"], 
#      y = nagao_results$test_statistics[, "standardized_stat"], 
#      type = "l",
#      main = "Nagao Test Statistics", 
#      xlab = "Candidate CP", 
#      ylab = "Statistic",
#      xlim = c(20, max(nagao_results$test_statistics[, "candidate_cp"])))  # Set x-axis to start at 20
# 
# # Add reference lines
# abline(v = nagao_results$change_point, col = "red")
# abline(h = nagao_results$critical_value, col = "blue", lty = 2)
